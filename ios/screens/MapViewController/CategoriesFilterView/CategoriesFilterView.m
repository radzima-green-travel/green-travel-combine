...
- (void)onFilterOptionsSelect:(NSUInteger)selectedIndex {
  ...
  [self scrollToItemAtIndexPath:[NSIndexPath indexPathForItem:dataCellIndex - 1 inSection:0] atScrollPosition:UICollectionViewScrollPositionLeft animated:TRUE];
}
